...
if g:isGUI
    ...
    winpos 200 50                                     "指定窗口出现的位置，坐标原点在屏幕左上角  "原来作者设置的是100  10
    set lines=26 columns=80                          "指定窗口大小，lines为高度，columns为宽度   "原来作者设置的是38  120
endif
...
"  < 单文件编译、连接、运行配置 >
" -----------------------------------------------------------------------------
"===========  F5 run python ==================== add by pengyong 20160120 
...
" =============================================================================
" 括号自动补全 add by pengyong 20160122
...
inoremap ` <c-r>=SamePair('`')<CR>
" =============================================================================
" 禁止产生undofile add by pengyong 20160430
" set noundofile "forbid generating undofile
set undofile
